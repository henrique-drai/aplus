...
function large_script($m) {
    ...
    $cadeira["82"] = $m->cadeira($curso["4"], "44712", "Introdução à Investigação Operacional", "IIO", 1, "Descrição default.", "#ffb3ec");
    $cadeira["83"] = $m->cadeira($curso["4"], "26725", "Princípios de Programação", "PP", 1, "Descrição default.", "#ffb3ec");
    $cadeira["84"] = $m->cadeira($curso["4"], "26704", "Redes de Computadores", "RComp", 1, "Descrição default.", "#ffb3ec");
    $cadeira["85"] = $m->cadeira($curso["4"], "26726", "Sistemas de Informação e Bases de Dados", "SIBD", 1, "Descrição default.", "#ffb3ec");
    $cadeira["86"] = $m->cadeira($curso["4"], "63485", "Desenvolvimento Centrado em Objetos", "DCO", 2, "Descrição default.", "#ffb3ec");
    $cadeira["87"] = $m->cadeira($curso["4"], "26749", "Interfaces Pessoa-Máquina", "IP-M", 2, "Descrição default.", "#ffb3ec");
    $cadeira["88"] = $m->cadeira($curso["4"], "13528", "Matemática Discreta", "MDisc", 2, "Descrição default.", "#ffb3ec");
    $cadeira["89"] = $m->cadeira($curso["4"], "17645", "Pensamento Crítico", "PCrit", 2, "Descrição default.", "#ffb3ec");
    $cadeira["90"] = $m->cadeira($curso["4"], "26703", "Sistemas Operativos", "SO", 2, "Descrição default.", "#ffb3ec");
    ...
    $grupo = array();
    $grupo["1"] = $m->grupo($projeto["1"], "gangdogpl");
    $grupo["2"] = $m->grupo($projeto["1"], "itachi");
    $grupo["3"] = $m->grupo($projeto["1"], "nota_21");
